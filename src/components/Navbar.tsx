      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 md:py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-8">
          ...
          <button 
            ...
            className="flex items-center gap-1.5 p-1 rounded-full bg-white/5 border border-white/10 hover:border-white/20 transition-all group"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative group">
              <div className="w-10 h-10 md:w-11 md:h-11 rounded-xl md:rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center cursor-pointer hover:bg-primary/10 hover:border-primary/30 transition-all duration-300">
              ...
              {/* Dropdown Menu */}
              <div className="absolute right-0 mt-3 w-48 md:w-56 py-3 glass-card opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 pointer-events-none group-hover:pointer-events-auto transition-all duration-300 transform origin-top-right">
                ...
                <button className="w-full flex items-center gap-3 px-5 py-2.5 text-xs md:text-sm hover:bg-white/5 transition-colors group/item">
